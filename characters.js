...
const characterDatabase = {
    ...
    "Scott": {
        ...
        skills: ["Accounting", "Botany", "French", "Investigation", "Legal", "Medical", "Bartender", "Banking", "willsDeath", "ledger", "forgedDocs", "stolenCompany", "europeanDeal", "margaretsLetter", "secretHeir", "margaretsLetter", "wolfsbane", "poisonTrail", "mirandasIdentity", "backgroundCheck", "popupTest", "Journalism"],
        ...
        knowledge: [
            ...
            { text: "Ran background checks on your guest list. Most came back clean. Charles Sterling has two unpaid parking tickets in Fort Worth. Thomas Bradford had a public intoxication charge dismissed in 1931. Two names flagged for name changes — Walter Lippman born Taylor Hartley. Miranda Longfellow matches a Miranda Hartley out of Dallas. Call me if you need more.", unlockedBy: "djPinkerton" }
        ],
        memories: [
            { text: "Your father came to your office once, unannounced, about two months ago. He sat across from your desk and looked at you for a long moment. Then he said, 'You're a good man, Scott. Better than I was.' You laughed it off. You wish now you hadn't.", unlockedBy: "margaretsLetter" },
            { text: "Miranda has always been exceptionally good at her job. Almost unnervingly so. She knew where every document was. Every file. You assumed it was diligence. It never occurred to you to ask why she cared so much.", unlockedBy: "mirandasIdentity" },
            { text: "The night your father called about making things right, there was something in his voice you couldn't name at the time. Not guilt exactly. More like relief. Like a man who had finally decided something.", unlockedBy: "mirandasIdentity" }
        ],
        canShare: [
    ...
    "Lindsey": {
        ...
        memories: [
            { text: "You were at a society dinner in March of 1902 when William Thoreson announced the formation of his new company. He mentioned a partner — a man named Hartley. A Robert Hartley. You shook the man's hand. He was quiet, serious, proud. You never saw him again after that summer.", unlockedBy: "letterhead", tier: 1 },
            ...
            { text: "You were present when the original incorporation was filed. You remember the name on the paperwork — Thoreson and Hartley, equal shares. Within a year the Hartley name had quietly disappeared. Will said the partnership had been dissolved by mutual agreement. Robert Hartley was not there to say otherwise.", unlockedBy: "incorporation", tier: 2 },
            ...
            { text: "You have been sitting here for two hours listening to Will Thoreson's voice come out of that machine, and the thing that strikes you most is how tired he sounds. Not guilty. Tired. Like a man who has been holding something very heavy for a very long time and has finally decided to set it down. You knew Will for thirty-two years. You never heard him sound like that before.", unlockedBy: "transcriptAct1", tier: 2 }
        ],
        canShare: [
