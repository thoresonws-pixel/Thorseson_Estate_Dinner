...
const characterDatabase = {
    ...
    "DJ": {
        ...
        memories: [
            ...
            { text: "DALLAS COUNTY CORONER\'S OFFICE\n─────────────────────\nDave —\n\nPreliminary findings on William A. Thoreson, deceased.\n\nCause of death: acute cardiac arrest secondary to toxic poisoning. Compound identified: Aconitine, derived from Aconitum napellus — commonly known as Wolfsbane. Onset rapid. Undetectable in standard post-dinner examination without specific screening.\n\nThis plant is not native to Texas or anywhere in the continental United States. Primary natural source: alpine regions of central Europe, particularly Switzerland and Austria.\n\nAdditional note: a small brass key was found in the deceased\'s left jacket pocket. No corresponding lock identified on his person. We are returning it to the family via you.\n\nFull report to follow.\n\n— F. Garrett, Dallas County Coroner", unlockedBy: "djCoroner" },
    ...
    "Jesse": {
        ...
        memories: [
            ...
            { text: "Earlier tonight — before dinner — you slipped out the back for some air. You heard William arguing with someone around the side of the house. A woman's voice, sharp and low. You caught one sentence clearly: 'I know everything.' Then something hit the ground hard — you heard it land. By the time you edged closer, William was alone, crouching down to pick something up off the ground. He saw you and straightened up immediately, slipped whatever it was into his jacket pocket, and walked back inside without a word. You never saw who the woman was.", unlockedBy: "fireSafeOpened" },
