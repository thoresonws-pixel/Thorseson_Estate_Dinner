...
const characterDatabase = {
    ...
    "Lindsey": {
        ...
        memories: [
            { text: "Years ago at a New Year's party, you overheard someone say that Will Thoreson hadn't built that company alone, and that the man who helped him build it hadn't seen a penny of it. The conversation stopped the moment they noticed you. You laughed it off then. You remember it now.", unlockedBy: "stolenCompany" },
            { text: "Eleanor always got quiet at a particular kind of party — the ones where Will was charming and easy with everyone in the room. Not jealous exactly. Something more resigned. You assumed it was just the wear of a long marriage. You are revising that assumption.", unlockedBy: "margaretsLetter" },
            { text: "You have attended enough of these evenings to know that the ones that end with a revelation always had the revelation in the room the whole time. Everyone who needed to be there was there. It was never an accident.", unlockedBy: "mirandasIdentity" }
        ],
        canShare: [
